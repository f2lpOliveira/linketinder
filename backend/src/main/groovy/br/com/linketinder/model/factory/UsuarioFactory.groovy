...
class UsuarioFactory {
    ...
    static Vaga criarVaga(String nome, String estado, String cep, String descricao, List<String> competencias) {
        return new Vaga(nome, estado, cep, descricao, competencias)
    }
}
